pipeline {
    ...
    stages {
        ...
        stage ('Checkout') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/BR_Sravan_Chamarthi']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/devops81/DevOps-Demo.git']]])
        ...
        stage ('Build the project') {
            steps {
                dir("/var/lib/jenkins/workspace/BR_SravanC_Pipeline_Project/examples/feed-combiner-java8-webapp") {
