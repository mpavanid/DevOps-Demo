pipeline {
    ...
    stages {
        ...
        stage ('Checkout') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/BR_Dinesh']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/devops81/DevOps-Demo.git']]])
        ...
        stage ('Deploy the application') {
            steps {
                ...
                sh 'cp  -rf  /var/lib/jenkins/workspace/Pipeline_Dinesh/examples/feed-combiner-java8-webapp/target/devops_ddines04.war /home/jarfile'
